package com.project.jobis.response;

import com.google.common.collect.Lists;
import com.project.jobis.exception.BusinessException;
import com.project.jobis.exception.ErrorCode;
import com.project.jobis.interceptor.CommonHttpRequestInterceptor;
...
public class CommonControllerAdvice {
    ...
    public CommonResponse onBaseException(BusinessException e) {
        String eventId = MDC.get(CommonHttpRequestInterceptor.HEADER_REQUEST_UUID_KEY);
